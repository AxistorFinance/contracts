...
contract('Lottery', (accounts) => {
    it('init', async () => {
        ...
        this.axor = await MockBEP20.deployed();
        ...
        await this.axor.transfer(bob, '2000', { from: minter });
        await this.axor.transfer(alice, '2000', { from: minter });
        await this.axor.transfer(carol, '2000', { from: minter });
    });
    ...
    it('test', async () => {
        ...
        carol=accounts[3];
        dev=accounts[4];
        await this.axor.approve(this.lotteryProxyAddress, '1000', { from: alice });
        await this.axor.approve(this.lotteryProxyAddress, '1000', { from: bob });
        ...
        assert.equal((await this.axor.balanceOf(this.lotteryProxyAddress)).toString(), '418');
